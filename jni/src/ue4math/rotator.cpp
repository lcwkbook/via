...
FRotator_class::FRotator_class(const FQuat& q) {
...
FQuat FRotator_class::GetQuaternion() const {
...
// FRotator_class::operator FQuat() const {
// 	return GetQuaternion();
// }

FMatrix_class FRotator_class::GetMatrix(FVector_class origin) const {
...
FVector_class FRotator_class::GetUnitVector() const {
	float radPitch = ConvertToRadians(Pitch);
	float radYaw = ConvertToRadians(Yaw);
	...
	return FVector_class(CP * CY, CP * SY, SP);
}
