 ...
 * Copyright (c) 2025 阿念 - AFan4724(主要作者)
 * Project: http://t.me/ZoeGoron
 *
 * 使用 Surface 重定向获取屏幕信息创建ui镜像实现过强制防录屏效果
 * 目前支持系统 Android 6 Android 7 Android 8 Android 9 Android 10 Android 11 Android 12 Android 13 Android 14 Android 15 Android 16 (包括小版本也已分别完成适配 - 有未适配的版本请反馈至 http://t.me/ZoeGoron)
 *
 * [ + ] 本次版本修复问题 - 屏幕方向转换后的屏幕信息获取 - 直播/共享屏幕/投屏 时的偏移问题
*/
