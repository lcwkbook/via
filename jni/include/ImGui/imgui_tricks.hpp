...
struct ImTrickyColor
{
	...
	inline std::string HTML() {
		int integers[4] = { (int)values[0] * 255, (int)values[1] * 255, (int)values[2] * 255, (int)values[3] * 255 };
...
namespace ImTricks {
	...
	*/
	...
	namespace Widgets {
		...
		extern void ColorEdit3(const char* label, ImColor& color, ImGuiColorEditFlags flags = 0);
		extern void ColorEdit4(const char* label, ImColor& color, ImGuiColorEditFlags flags = 0);
		extern void ColorEdit3(const char* label, ImTrickyColor& color, ImGuiColorEditFlags flags = 0);
		extern void ColorEdit4(const char* label, ImTrickyColor& color, ImGuiColorEditFlags flags = 0);
