...
class 绘制
{
    ...
    struct ColorTable
    {
        float 方框颜色[4] = {0.0, 1.0, 0.0, 1.0};     // 真人可见→亮绿 🟢
        float 方框掩体颜色[4] = {1.0, 0.2, 0.2, 1.0}; // 真人遮挡→亮红 🔴
        float 射线颜色[4] = {0.0, 1.0, 0.0, 1.0};     // 真人可见→亮绿 🟢
        float 射线掩体颜色[4] = {1.0, 0.5, 0.0, 1.0}; // 真人遮挡→橙红 🟠
        float 骨骼颜色[4] = {0.0, 1.0, 0.0, 1.0};     // 真人可见→亮绿 🟢
        float 骨骼掩体颜色[4] = {1.0, 0.2, 0.2, 1.0}; // 真人遮挡→亮红 🔴
