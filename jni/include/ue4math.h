...
/**
 * Calculate the inverse of an FMatrix_class.
 *
 * @param DstMatrix		FMatrix_class pointer to where the result should be stored
 * @param SrcMatrix		FMatrix_class pointer to the Matrix to be inversed
 */
