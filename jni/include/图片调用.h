#ifndef 手持调用_H
#define 手持调用_H
#include "./include/vulkan/VulkanUtils.h"
#include <map>
...
手持图片[201] = createTexture_ALL_FromMem(群众, sizeof(群众));
手持图片[202] = createTexture_ALL_FromMem(骷髅, sizeof(骷髅));
手持图片[203] = createTexture_ALL_FromMem(准星, sizeof(准星));
手持图片[204] = createTexture_ALL_FromMem(齿轮, sizeof(齿轮));
